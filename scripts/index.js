...
customElements.define('staff-list', class extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
	...
	constructor()
	{
		...
		if (!this.staffs) {
			this.staffs = [ ];
			(async () => {
				this.staffs = js_yaml__WEBPACK_IMPORTED_MODULE_1__["default"].load(await (await fetch('/staffs.yaml')).text());
			})();
		}
	}
	...
	render()
	{
		return lit__WEBPACK_IMPORTED_MODULE_0__.html`<table>
			...
			<tbody>${this.staffs && this.staffs.map(staff => lit__WEBPACK_IMPORTED_MODULE_0__.html`<tr>
...
/* harmony import */ var _staff_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./staff-list.js */ "./docs/scripts/staff-list.js");
